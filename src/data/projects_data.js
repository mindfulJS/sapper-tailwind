  ...
  return [
    {
      ...
      description: "Full Inventory of instruments",
      comments:
        "This is a One HTML page challenge! The goal was to build a single page application in ONE html file in Javascript only (no framework).",
    ...
    },
    {
      ...
      description:
        "A library for using the latest Material Design components in Svelte.",
      comments:
        "Implemented some HTML templates ready to use for greenfield projects.",
